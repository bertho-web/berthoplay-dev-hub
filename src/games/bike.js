  ...
  initTouchAndKeyboardUI() {
    ...
    this.ui.innerHTML = `
      <style>
        ...
        .hud-pos { font-size: 0.8rem; font-weight: 900; color: var(--gold); margin-top: 2px; }
        ...
        .icon-btn-sound { background: var(--surface-2); border: 1px solid var(--line-strong); color: #fff; padding: 4px 8px; border-radius: 6px; cursor: pointer; margin-bottom: 4px; font-size: 0.8rem; }
      ...
      <div class="modal" id="win-modal">
        <h2 style="color:var(--violet-lit); font-size:1.5rem; margin-bottom:10px;">ÉTAPE VALIDÉE ! 🏆</h2>
      ...
      <div class="modal" id="fail-modal" style="border-color:var(--blood-lit);">
        <h2 style="color:var(--blood-lit); font-size:1.5rem; margin-bottom:10px;">ÉCHEC CHRONO ! 💥</h2>
